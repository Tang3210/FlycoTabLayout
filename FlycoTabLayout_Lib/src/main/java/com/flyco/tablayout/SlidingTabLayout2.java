...
public class SlidingTabLayout2 extends HorizontalScrollView {
     ...
     */
    public void setViewPager(ViewPager2 vp, String[] titles, FragmentActivity fa, SparseArray<Fragment> fragments) {
        if (vp == null) {
        ...
        this.mViewPager2 = vp;
        this.mViewPager2.setAdapter(new InnerPagerAdapter2(fa, fragments, titles));
     ...
     * 关联ViewPager2,用于连适配器都不想自己实例化的情况
     */
    public void setViewPager(ViewPager2 vp, String[] titles, Fragment fa, SparseArray<Fragment> fragments) {
        if (vp == null) {
            throw new IllegalStateException("ViewPager can not be NULL !");
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    class InnerPagerAdapter2 extends FragmentStateAdapter {
        private SparseArray<Fragment> fragments = new SparseArray<>();
        private String[] titles;

        public InnerPagerAdapter2(FragmentActivity fa, SparseArray<Fragment> fragments, String[] titles) {
            super(fa);
            this.fragments = fragments;
            this.titles = titles;
        }

        public InnerPagerAdapter2(Fragment fm, SparseArray<Fragment> fragments, String[] titles) {
            super(fm);
            this.fragments = fragments;
            this.titles = titles;
        }
